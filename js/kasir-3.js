function tambahKeKeranjang(barangId, namaBarang, hargaSatuan) {
  ...
  if (existingItem) {
    ...
    const jumlahKeluar = parseInt(jumlahElement.value);
    ...
    keranjangItem.innerHTML = `
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex align-items-center">
                ...
                <input type="number" style="max-width: 80px;" class="jumlahKeluar form-control mx-2" value="1" min="0" oninput="updateJumlah('${barangId}', ${hargaSatuan}, this.value)">
