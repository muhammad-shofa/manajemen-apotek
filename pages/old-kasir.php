...
<body id="page-top">
    ...
    <!-- 11-5 masih experiment menambahkan agar harga satuan / harga butirnya dapat diedit -->
    <!-- <script src="../js/kasir-11-5.js"></script> -->
    <!-- 11 BISA DAN NORMAL, JUMLAH KELUAR DAPAT DIEDIT SESUAI KEINGINAN, NAMUN UNTUK EDIT HARGANYA BELUM -->
    ...
    <script>
        $(document).ready(function () {
                                ...
                                results.forEach(function (item) {
                                    html += `
                                     <div class="card m-2 p-2">
                                         ...
                                         <button onclick="tambahKeKeranjang('${item.barang_id}')" 
            ...
            //     $.ajax({
            //         url: 'ajax-kasir-2.php', // File backend untuk memproses
            //         type: 'POST',
            ...
            // Malam sabtu, 7 Desember 2024
            // function tambahKeKeranjang(barang_id) {
            //     fetch('ajas-kasir-2.php?mulai_transaksi=1', {
            //         method: 'POST',
            //         headers: {
            //             'Content-Type': 'application/json',
            //         },
            //         body: JSON.stringify({ barang_id: barang_id }),
            //     })
            ...
            // 
            // function tambahKeKeranjang(barang_id, nama, harga_satuan, harga_butir) {
            //     fetch('ajas-kasir-2.php?ambil=harga', { // ambil harga_satuan dan harga_butir dari table barang
            //         method: 'POST',
            ...
            //         .then(data => {
            //             if (data.success) {
            //                 alert(`Nama: ${nama}\nHarga Satuan: ${data.harga_satuan}\nHarga Butir: ${data.harga_butir}`);
            //                 // Lakukan hal lain, misalnya tambahkan barang ke keranjang.
            //             } else {
